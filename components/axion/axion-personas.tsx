...
const personas = [
  {
    role: "Founder / CEO",
    title: "See where your organisation will break before it does",
    body: "Most founder-led companies don't fail on strategy. They fail because the belief that built the company never became conviction that could survive the founder's absence. You get a diagnostic for exactly that — and a design to fix it while you still have time.",
    outcome: "→ Reduce founder dependency risk before it becomes a board conversation",
  },
  {
    role: "CFO",
    title: "Understand workforce as cost, risk, and control — not headcount",
  ...
  {
    role: "CHRO",
    title: "Move from program ownership to system architecture",
  ...
  {
    role: "Board",
    title: "Gain visibility into invisible organisational risk",
    ...
    >
      ...
      >
        ...
        <div className={`rv ${visible ? "in" : ""}`} style={{ marginBottom: "3.5rem", maxWidth: "720px" }}>
          ...
          >
            Clarity for every <em style={{ fontStyle: "italic", color: "var(--rust)" }}>decision-maker.</em>
          </h2>
        </div>
